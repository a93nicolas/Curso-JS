...
// Asignar valor a variables
    ...
    // Variables con cadena de caracteres
        ...
        // Funciones flecha
            ...
            */
            ...
            // Valores por defecto para parametros
                ...
                /*
                    El valor por defecto se pasa en el parametro
                    en este caso , valor = 1. Cuandos se pase un 
                    un segundo parametro, este pasara a tener ese valor
                */

                const INCREMENTAR = (num, valor = 1) => num + valor;

                        console.log(INCREMENTAR(5));
                        console.log(INCREMENTAR(5, 8));

            // Operador rest

                /*
                    Se escribe "...args", convierte los argumentos
                    en elementos de un solo arreglo
                */

                    function funcionRest(...args) {
                        console.log(args);
                    }
            ...
            // Operador .reduce
                ...
                /*
                    .reduce() suma los elementos del arreglo
                    y retorna el resultado
                */

                    const SUMAR_CUATRO = (...args) => {
            ...
            // Operador .spread
                ...
                /*
                    Toma un arreglo y descompone en sus elementos individuales

                */

                    const NUMEROS_SPREAD = [1, 2, 3];

                    function ejSpread (a, b, c) {
                        return a + b + c;
                    }

                    console.log(ejSpread(...NUMEROS_SPREAD));
            ...
            // Sintaxis de desestructuracion
                ...
                */
                    ...
                    const nombre_uno = USUARIO_UNO.nombre;
                    const edad_uno = USUARIO_UNO.edad;
            ...
            // Sintaxis de desestructuracion: objetos anidados
                ...
                const USUARIO_DOS = {
                    jhonDoe : {
                        edad : 27,
                        correo : "jhondoe@htm.com"

                    }
                };

                const {jhonDoe: {edad, correo}} = USUARIO_DOS;
        ...
        // Sintaxis de desestructuracion con el operador rest
            ...
            [dd, ee, ...arrgs] = [7, 8, 9, 10, 11, 12, 13];

            console.log(dd, ee, arrgs);


            const arregloInicial = [1, 2, 3, 4, 5, 6, 7, 8];

            function removerTresPrimeros(arreglo) {
                const [ , , , ...nuevoArreglo] = arreglo;
                return nuevoArreglo;
            }
    
            const arregloFinal = removerTresPrimeros(arregloInicial);
        ...
        // Sintaxis de desestructuracion pasar objeto como argumento
                ...
                /*
                    const actualizarPerfil = (informacionDePerfil) => {
                        const {nombre_p, edad_p, nacionalidad, ubicacion} = informacionDePerfil;
                ...
                */
                    ...
                    const actualizarPerfil = ({nombre_p, edad_p, nacionalidad, ubicacion}) => {
        ...
        // Plantillas literales
            ...
            */
                ...
                var ej_a = 6;
                    ...
                    console.log(`El valor de ej_a es ${ej_a}`);

                var nombre_ejemplo = "Mick";
                var apellido_ejemplo = "jagger";

                    console.log(`Hola crack, soy ${nombre_ejemplo + " " + apellido_ejemplo}`);
                ...
                var persona_ejemplo = {
                    ...
                    const SALUDO = `Hola mi nombre es ${persona_ejemplo.nombre_gi} y tengo ${persona_ejemplo.edad_gi} años`;
            ...
            // Crear objetos de forma concisa
                ...
                /*
                    ...
                    console.log(crearPersona("Jefferson Gutierrito", 25, "Mexicano"));
                */
            ...
            // Metodos
                ...
                /*
                    this. trabaja sobre una funcion dentro de un objeto para llamar
                    a las diferentes propiedades sin necesidad de poner el nombre del objeto
                */

                    const persona_nueva = {
                        nombre_nue: "Isabel",
                        presentarse() {
                            return `Hola mi nombre es ${this.nombre_nue}`;
                            }
                        };

                        console.log(persona_nueva.presentarse());

            // Definir una clase

                /*
                    Es similar a un plano de un edificio, nos permite escribir
                    codigo una vez y crear los objetos que querramos
                */
                    ...
                    var zeuz = new TransbordadorEspacial("Jupiter");

                        console.log(zeuz.planeta);
                    ...
                    var miMascota = new Mascota("Sarita", 4);
            ...
            // Getters y setters
                ...
                /*
                    Los getters son metodos que nos permiten obtener el valor de una propiedad privada
                    Los setter nos permiten actualizar el valor de una propiedad
                */
                    ...
                    const LibroNuevo = new Libro("Anonimo");

                        console.log(LibroNuevo.autor);

                    LibroNuevo.autor = "Stephen King";
